...
- Computationally heavy, N $\approx$ 500, 32 chains, 15000 steps.
- No mention of priors.
- Where does the "quasi" come from?
    - LSP and WWZ target periodicity, not quasi-periodicity.
    - Why not use QP GP kernels.
- [Aside] More data $\rightarrow$ more likely to reach significance.
    - 3$\sigma$ vs. 5$\sigma$ might not itself be significant.
